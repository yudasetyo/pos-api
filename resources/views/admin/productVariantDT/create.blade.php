...
<div class="bg-white rounded-lg shadow-lg p-6 sm:p-8 max-w-2xl mx-auto">
    ...
    <form action="{{ route('productVariantDT.store') }}" method="POST">
        @csrf
        <div class="space-y-6 sm:space-y-8">
            <div class="relative">
                <input id="productVariantDTName" name="productVariantDTName" type="text" class="block w-full px-4 py-3 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-colors duration-300 peer">
            ...
            <div class="relative">
                <input id="productVariantDTPrice" name="productVariantDTPrice" type="number" class="block w-full px-4 py-3 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-colors duration-300 peer">
