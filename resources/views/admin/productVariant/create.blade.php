...
<div class="bg-white rounded-lg shadow-lg p-6 sm:p-8 max-w-2xl mx-auto">
    ...
    <form action="{{ route('productVariant.store') }}" method="POST">
        ...
        <div class="space-y-6 sm:space-y-8">
            <div class="relative">
                <input id="productVariantName" name="productVariantName" type="text" placeholder=" " class="block w-full px-4 py-3 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-colors duration-300 peer">
            ...
            <div class="space-y-1">
                ...
                <div class="flex items-center">
                    ...
                    <input id="isRequired" name="isRequired" type="checkbox" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
